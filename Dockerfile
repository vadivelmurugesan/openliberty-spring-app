...
# ------------------------------------------------------------
# ▶ Usage Guide (for CI/CD and Developers)
# ------------------------------------------------------------
# 🔧 Build (e.g., in Jenkins, GitHub Actions):
# docker build \
#   --build-arg APP_NAME=hello-service \
#   --build-arg APP_VERSION=2.1.0 \
#   -t your-org/hello-service:2.1.0 .

# ▶ Run locally:
# docker run -p 9080:9080 your-org/hello-service:2.1.0

# ▶ Kubernetes:
# Use readinessProbe for /actuator/health on port 9080